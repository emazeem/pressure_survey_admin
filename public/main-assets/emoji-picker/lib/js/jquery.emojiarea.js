...
(function($, window, document) {
  ...
  */
   ...
   */
  $.emojiarea = {
    assetsPath : window.location.origin+'/main-assets/emoji-picker/lib/img',
    spriteSheetPath: '',
    blankGifPath: '',
    iconSize : 25,
    icons : {},
  ...
  EmojiArea.createIcon = function(emoji, menu) {
    ...
    var column = emoji[2];
    var name = emoji[3];
    var filename = window.location.origin+'/main-assets/emoji-picker/lib/img/emoji_spritesheet_!.png';
    var blankGifPath = window.location.origin+'/main-assets/emoji-picker/lib/img/blank.gif';
